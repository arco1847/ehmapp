...
INSERT INTO prescriptions (user_id, medication, strength, dosage, quantity, doctor_name, pharmacy_name, refills, instructions) VALUES
(1, 'Amoxicillin', '500mg', '3 times daily', '30 tablets', 'Dr. Smith', 'CVS Pharmacy', 2, 'Take with food. Complete the full course.'),
(1, 'Lisinopril', '10mg', 'Once daily', '90 tablets', 'Dr. Johnson', 'Walgreens', 5, 'Take in the morning with water.'),
(1, 'Metformin', '500mg', 'Twice daily', '60 tablets', 'Dr. Brown', 'CVS Pharmacy', 3, 'Take with meals to reduce stomach upset.');

-- Sample Appointments
INSERT INTO appointments (user_id, doctor_id, doctor_name, specialty, appointment_date, appointment_time, duration, status, type, location) VALUES
(1, 1, 'Dr. Sarah Johnson', 'Cardiologist', '2024-02-15', '10:00:00', 30, 'Confirmed', 'In-Person', 'Heart Care Center, 123 Medical Ave'),
(1, 2, 'Dr. Michael Brown', 'General Practitioner', '2024-02-20', '14:30:00', 45, 'Pending', 'Telemedicine', 'Video Call');
...
(1, 'Prescription Reminder', 'Time to take your Amoxicillin 500mg', 'medication', 'high'),
(1, 'Appointment Reminder', 'You have an appointment with Dr. Johnson tomorrow at 10:00 AM', 'appointment', 'medium');